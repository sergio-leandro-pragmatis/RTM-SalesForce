...
if choice == menu[0]:
    ...
    if busca:
        ...
        st.write(f'Tempo Médio entre PDVs (hrs - v = 50km/h): {tempo_medio}')
        st.write(f'Tempo Médio entre PDVs (hrs - v = 40km/h): {tempo_medio_40}')
        st.write(f'Tempo Médio entre PDVs (hrs - v = 60km/h): {tempo_medio_60}')
